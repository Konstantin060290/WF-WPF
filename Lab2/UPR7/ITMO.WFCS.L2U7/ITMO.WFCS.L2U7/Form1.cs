    ...
    public partial class Form1 : Form
    {
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (checkBox1.Checked == true)
            {
                ...
                txt.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.richTextBox2_KeyPress);
            }
            else
            {
                int lcv;
        ...
        private void richTextBox1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            errorProvider1.SetError(richTextBox1, "Must be letter");
        }
        ...
        private void richTextBox2_Validating(object sender, CancelEventArgs e)
        {
            ...
            else
            {
                try
                {
                    double.Parse(richTextBox2.Text);
                    e.Cancel = false;
                }
                catch
                {
